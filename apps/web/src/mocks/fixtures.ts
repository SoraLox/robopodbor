...
export const objectParameters: Record<string, ParameterField[]> = {
  warehouse: [
    ...
    { id: 'flow', label: 'Грузопоток', unit: 'паллет/сут', hint: 'Среднесуточный оборот на приёмке и отгрузке', kind: 'number', min: 1, defaultValue: '1850' },
  ...
  airport: [
    ...
    { id: 'shifts', label: 'Сменность', kind: 'number', min: 1, max: 3, defaultValue: '3' },
    { id: 'uav', label: 'Инспекция БАС', hint: 'Осмотр перрона и полосы беспилотниками', kind: 'select', defaultValue: 'planned',
      options: [
